...
def makeCommandMenu():
    ...
    CmdBtn.menu.add_command(label='Wild Font', underline=0, font=('Tempus Sans ITC', 14), command='stub_action')
...
def makeCascadeMenu():
    ...
    CasBtn.menu.choices.wierdones.add_command(label='Quantity Surbeyor')
    ...
    CasBtn.menu.choices.add_command(label='Filling Cabinet')
...
def makeCheckbuttonMenu():
    ...
    ChkBtn.menu.add_checkbutton(label='Stig Tracy')
